...
const MICRO_APP_NAME = 'eiscore-decision'
const DEV_STANDALONE_PORT = '8091'
...
const lifecycle = {
  bootstrap() { console.log('[decision] bootstrap') },
  mount(props) {
    console.log('[decision] mount')
    render(props)
  },
  unmount() {
    console.log('[decision] unmount')
    unmountApp()
  },
  update() {}
}

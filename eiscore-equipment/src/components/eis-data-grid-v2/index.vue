...
.ag-theme-alpine .attention-row-critical .ag-cell:first-child { border-left: 3px solid #dc2626; }
.ag-theme-alpine .attention-row-warning .ag-cell:first-child { border-left: 3px solid #d97706; }
.ag-theme-alpine .attention-row-focus .ag-cell:first-child { border-left: 3px solid #2563eb; }
.ag-theme-alpine .attention-row-critical { background-color: #fff7f7; }
.ag-theme-alpine .attention-row-warning { background-color: #fffaf0; }
.ag-theme-alpine .attention-row-focus { background-color: #f4f8ff; }
.ag-theme-alpine .attention-cell-critical,
.ag-theme-alpine .attention-cell-warning,
.ag-theme-alpine .attention-cell-focus,
.ag-theme-alpine .attention-cell-normal {
  font-weight: 700;
}
.ag-theme-alpine .attention-cell-critical { color: #dc2626; }
.ag-theme-alpine .attention-cell-warning { color: #d97706; }
.ag-theme-alpine .attention-cell-focus { color: #2563eb; }
.ag-theme-alpine .attention-cell-normal { color: #64748b; font-weight: 500; }

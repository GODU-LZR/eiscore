...
const MICRO_APP_NAME = 'eiscore-equipment'
const DEV_STANDALONE_PORT = '8090'
...
const lifecycle = {
  bootstrap() { console.log('[equipment] bootstrap') },
  mount(props) {
    console.log('[equipment] mount')
    render(props)
  },
  unmount() {
    console.log('[equipment] unmount')
    unmountApp()
  },
  update() {}
}

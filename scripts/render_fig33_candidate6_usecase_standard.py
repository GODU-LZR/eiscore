...
actor(draw, 2270, 330, "销售文员")
actor(draw, 2270, 930, "系统管理员")
...
# left associations
assoc(draw, (165, 340), (560, 305))
assoc(draw, (165, 370), (560, 555))
assoc(draw, (165, 810), (560, 805))
assoc(draw, (165, 840), (560, 555))

# right associations
assoc(draw, (2235, 280), (1850, 275))  # 销售文员-库存台账查询
assoc(draw, (2235, 310), (1850, 485))  # 销售文员-销售出库
assoc(draw, (2235, 880), (1850, 715))  # 系统管理员-批次与保质期查看
assoc(draw, (2235, 910), (1850, 955))  # 系统管理员-库存预警与状态核对

# system管理员到库存台账查询使用折线，避免与销售文员线交叉
poly_assoc(draw, [(2235, 940), (2140, 940), (2140, 180), (1850, 180), (1850, 275)])

out = Path("/home/lzr/eiscore/docs/diagrams/图3-3_仓储与库存作业用例图_候选版6.png")

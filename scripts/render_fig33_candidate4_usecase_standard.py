...
draw.rectangle((940, 140, 1460, 200), fill="white")
...
actor(draw, 2270, 860, "系统管理员")

# left use cases
left_cases = {
    "领料": (560, 260, 420, 110, "生产领料"),
    "补料": (560, 480, 420, 110, "生产补料"),
    "入库": (560, 700, 420, 110, "生产入库"),
}

# right use cases
right_cases = {
    "台账": (1400, 220, 420, 110, "库存台账查询"),
    "出库": (1400, 410, 420, 110, "销售出库"),
    "批次": (1400, 600, 420, 110, "批次与保质期查看"),
    "预警": (1400, 790, 420, 110, "库存预警与状态核对"),
}
...
assoc(draw, (165, 355), (560, 535))   # 仓管员-生产补料
assoc(draw, (165, 770), (560, 755))   # 生产主管-生产入库
assoc(draw, (165, 795), (560, 535))   # 生产主管-生产补料

# right associations without crossings
assoc(draw, (2235, 310), (1820, 275))   # 销售文员-库存台账查询
assoc(draw, (2235, 340), (1820, 465))   # 销售文员-销售出库
assoc(draw, (2235, 810), (1820, 655))   # 系统管理员-批次与保质期查看
assoc(draw, (2235, 840), (1820, 845))   # 系统管理员-库存预警与状态核对
assoc(draw, (2235, 870), (1820, 275))   # 系统管理员-库存台账查询

out = Path("/home/lzr/eiscore/docs/diagrams/图3-3_仓储与库存作业用例图_候选版4.png")

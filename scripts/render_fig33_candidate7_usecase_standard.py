...
cases = {
    ...
    "台账": (1420, 240, 430, 110, "库存台账查询"),
    "出库": (1420, 470, 430, 110, "销售出库"),
    "批次": (1420, 700, 430, 110, "批次与保质期查看"),
    "预警": (1420, 930, 430, 110, "库存预警与状态核对"),
}
...
# right actor associations - only primary relations
assoc(draw, (2235, 310), (1850, 295))  # 销售文员-库存台账查询
assoc(draw, (2235, 340), (1850, 525))  # 销售文员-销售出库
assoc(draw, (2235, 800), (1850, 755))  # 系统管理员-批次与保质期查看
assoc(draw, (2235, 830), (1850, 985))  # 系统管理员-库存预警与状态核对

out = Path("/home/lzr/eiscore/docs/diagrams/图3-3_仓储与库存作业用例图_候选版7.png")

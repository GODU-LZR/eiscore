...
SET value = jsonb_set(
  ...
  COALESCE(value -> 'loginBranding', '{}'::jsonb) || jsonb_build_object(
    ...
    'carouselImages', jsonb_build_array(
      jsonb_build_object('url', '/company-site/assets/jinwei/research-gallery/gallery-001.png', 'title', '厂区大门', 'subtitle', '湛江市经纬网厂'),
      jsonb_build_object('url', '/company-site/assets/jinwei/research-gallery/gallery-003.png', 'title', '网衣装配', 'subtitle', '大面积生产现场'),
      jsonb_build_object('url', '/company-site/assets/jinwei/research-gallery/gallery-002.png', 'title', '织造工位', 'subtitle', '多机台生产区域'),
      jsonb_build_object('url', '/company-site/assets/jinwei/research-gallery/gallery-015.jpeg', 'title', '深远海应用', 'subtitle', '养殖网箱工程场景')
    )
  ),
  true
)
...
SET blocks = jsonb_set(
  ...
  COALESCE(blocks -> 'hero', '{}'::jsonb) || jsonb_build_object(
    'image', '/company-site/assets/jinwei/research-gallery/gallery-001.png'
  ),
  true
),
updated_at = now()
